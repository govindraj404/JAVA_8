...
import cds.gen.configurationservice.DeactivateSourceReferenceTypeMappingsContext;
...
public class DeactivateSourceReferenceTypeMappingsHandlerTest {

    @InjectMocks
    DeactivateSourceReferenceTypeMappingsHandler handler;
    @Mock
    ...
    @Mock
    DeactivateSourceReferenceTypeMappingsContext context;
    ...
    public void deactiveComplainTypesTest() {
        ...
        handler.deactivateSourceReferenceTypeMappings(context);
    }
    ...
    @Test
    public void afterDeactivateSourceReferenceTypeMappingsTest()
    {
        when(context.getCqn()).thenReturn(cqnSelect);
        when(context.getService()).thenReturn(cdsService);
        when(cdsService.run(any(CqnSelect.class))).thenReturn(result);
        when(result.single(SourceReferenceTypeMappings.class)).thenReturn(sourceReferenceType);
        handler.afterDeactivateSourceReferenceTypeMappings(context);
    }
}