...
public class CopyBusinessObjectConfigurationHandlerTest {
    @Mock
    DraftService draftService;
    @InjectMocks
    CopyBusinessObjectConfigurationHandler handler;
    @Mock
    MessageKeys keys;
    ...
    @Mock
    private CopyBusinessObjectConfigurationContext context;
    @Mock
    ...
    @Test
    public void copyBusinessObjectConfigurationTest() {
        ...
        when(result.single(BusinessObjectConfigurations.class)).thenReturn(businessObjectConfigurations);
        when(draftService.newDraft(any(CqnInsert.class))).thenReturn(result);
        handler.copyBusinessObjectConfiguration(context);
    }
