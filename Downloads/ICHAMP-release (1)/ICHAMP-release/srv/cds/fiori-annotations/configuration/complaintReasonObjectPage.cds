...
annotate ConfigurationService.ComplaintReasons with @(UI : {
   Identification :[
            {Value : ID},
             {	
                $Type  : 'UI.DataFieldForAction',	
                Label  : '{i18n>ACTIVATE}',
                Action: 'ConfigurationService.ReactivateComplaintReasons',
                ![@UI.Hidden]: isActive
            },	
            {	
                $Type  : 'UI.DataFieldForAction',	
                Label  : '{i18n>DEACTIVATE}',
                Action: 'ConfigurationService.DeactivateComplaintReasons',
                ![@UI.Hidden]: isInActive
            }
        ],
        
         HeaderInfo                  : {
        TypeName       : '{i18n>COMPLAINT_REASON}',
        TypeNamePlural : '{i18n>COMPLAINT_REASONS}',
        Title          : {
            $Type : 'UI.DataField',
            Label : '{i18n>CODE}',
            Value : code
