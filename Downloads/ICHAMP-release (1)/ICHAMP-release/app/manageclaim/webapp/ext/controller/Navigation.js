    ...
    function (Dialog, DialogType, Button, ButtonType, Text) {
        ...
        return {
            onNavigationButtonPress: function (oContext, aSelectedContexts) {
                var oView = this.extension.cmh.manageclaim.OPExtend.getView(),
                    ...
                    oClaimNumberBinding = this.getModel().bindList("/Claims", undefined, undefined, aFilters, {});
                oClaimNumberBinding.attachEventOnce("dataReceived", function (oClaimNumberEvent) {
                    var sSemanticObject = "claim",
                        sAction = "managewd",
                        oObject = oClaimNumberEvent && oClaimNumberEvent.getSource() &&
                            oClaimNumberEvent.getSource().getContexts() &&
                            oClaimNumberEvent.getSource().getContexts()[0] && oClaimNumberEvent.getSource().getContexts()[0].getObject(),
                ...
                oClaimNumberBinding.getContexts();
            }
        }
    }
);