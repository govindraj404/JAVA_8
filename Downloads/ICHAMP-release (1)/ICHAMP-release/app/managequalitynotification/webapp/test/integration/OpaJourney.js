sap.ui.define(['sap/ui/test/opaQunit','sap/ui/test/actions/Press','sap/ui/test/Opa5'], function(opaTest,Press,Opa5) {
    ...
    var Journey = {
        run: function() {
            ...
            opaTest('#2: Object Page : Check Object Details Button',function(Given,When,Then){
                When.waitFor({
                    id : "cmh.managequalitynotification::QualityNotificationsObjectPage--fe::CustomAction::NavigationAction",
                    actions : new Press(),
