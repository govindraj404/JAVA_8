  ...
  QUnit.module("Resource Model", {
		beforeEach: function () {
			this._oResourceModel = new ResourceModel({
				bundleUrl: sap.ui.require.toUrl("cmh/managequalitynotification") + "/i18n/i18n.properties"
			});
		},
		afterEach: function () {
    ...
    QUnit.test("Should return the translated texts", function (assert) {
		...
		// Assert
		assert.strictEqual(i18nModel.getText("APPLICATION_TITLE"), "Manage Quality Notification", "Returns Application Title");
